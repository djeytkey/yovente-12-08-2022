                    ...
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            <select id="status_id" name="status_id" class="selectpicker form-control" data-live-search="true" >
                                <option value="All"><?php echo e(trans('file.All Status')); ?></option>
                                <option value="Open"><?php echo e(trans('file.Open')); ?></option>
                                <option value="Closed"><?php echo e(trans('file.Closed')); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\yovente\resources\views/tickets/index.blade.php ENDPATH**/ ?>